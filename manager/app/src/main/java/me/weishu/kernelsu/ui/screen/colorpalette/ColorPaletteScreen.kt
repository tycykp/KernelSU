...
fun ColorPaletteScreen() {
    ...
    val actions = ColorPaletteScreenActions(
        ...
        onSetWallpaperPath = viewModel::setWallpaperPath,
        onSetWallpaperBlur = viewModel::setWallpaperBlur,
        onSetWallpaperDim = viewModel::setWallpaperDim,
        onSetWallpaperOpacity = viewModel::setWallpaperOpacity,
        onSetWallpaperUiOpacity = viewModel::setWallpaperUiOpacity,
        onSetWallpaperCropScale = viewModel::setWallpaperCropScale,
        onSetWallpaperPositionX = viewModel::setWallpaperPositionX,
        onSetWallpaperPositionY = viewModel::setWallpaperPositionY,
