...
data class ColorPaletteScreenActions(
    ...
    val onSetWallpaperPath: (String?) -> Unit,
    val onSetWallpaperBlur: (Float) -> Unit,
    val onSetWallpaperDim: (Float) -> Unit,
    val onSetWallpaperOpacity: (Float) -> Unit,
    val onSetWallpaperUiOpacity: (Float) -> Unit,
    val onSetWallpaperCropScale: (Float) -> Unit,
    val onSetWallpaperPositionX: (Float) -> Unit,
    val onSetWallpaperPositionY: (Float) -> Unit,
